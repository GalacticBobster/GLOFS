...
tisfc      = fh.variables['tisfc'][:]
twsfc      = fh.variables['twsfc'][:]
aicec      = fh.variables['aice'][:]
vicec      = fh.variables['vice'][:]
tsfc      = fh.variables['tsfc'][:]
...
print ('interp_skintemp_5lakes_ice_fv3grid_ver7_GLcropped.py completed successfully')
