...
/20201023/MRMS_MergedReflectivityComposite_00.50_20201023-000020.grib2.gz
...
while curr_dt <= end_dt:
  ...
  response = s3.list_objects_v2(
    ...
    Prefix=f'CONUS/MergedReflectivityQCComposite_00.50/{ymd}/'
  )

  for obj in response.get('Contents', []):
    key = obj['Key']  # Full path to each file
    if f"MRMS_MergedReflectivityQCComposite_00.50_{ymd}-{hour}00" in key:
        print(key)
