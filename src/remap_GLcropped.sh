...
cp fv3mask_C3463_GLcropped.nc ./tmp.nc
...
python3 ./interp_skintemp_5lakes_ice_fv3grid_ver7_GLcropped.py $output_erie $output_mh $output_sup $output_ont > python.log
